...
import com.imaginebd.trellohayven.database.OrganizationMembersTable;
import com.imaginebd.trellohayven.internet.AddMembersHandler;
import com.imaginebd.trellohayven.internet.TrelloMember;
...
public class AddMembersList extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		membersHandler = new AddMembersHandler(this, membersList, orgoId, accountName);
